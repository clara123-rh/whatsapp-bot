...
module.exports = {
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY === undefined ? 'true' : process.env.HEROKU_API_KEY,
        APP_NAME: process.env.HEROKU_APP_NAME === undefined ? 'true' : process.env.HEROKU_APP_NAME
    },
